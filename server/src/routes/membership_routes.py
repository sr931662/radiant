...
from src.schemas.membership import (
    MembershipPlanResponse, MembershipResponse, MembershipListResponse,
    MembershipCardResponse, MembershipPlanCreateRequest,
    MembershipPaymentOrderResponse, MembershipVerifyPaymentRequest,
)
from src.controllers.membership_controller import (
    get_plans, apply, create_payment_order, verify_payment, my_memberships, download_card, renew,
...
public_router.post("/payment-order", response_model=MembershipPaymentOrderResponse)(create_payment_order)
public_router.post("/verify-payment", response_model=MembershipResponse, status_code=201)(verify_payment)
